...
// Panel de debug de RED (antes NetworkDebugUI, ahora hijo de DebugHud): rol,
// tick, world origin y posiciones de las entidades para debugear sincronización.
public class DebugRedUI : MonoBehaviour
{
    private void OnGUI()
    {
        ...
        // Panel derecho para no tapar la UI del lobby (dentro del area segura)
