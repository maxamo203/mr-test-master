...
{
    [Serializable]
    public struct ScanV2Observation
    {
        public Vector3 positionLocal;
        public Vector3 normalLocal;
        [Range(0f, 1f)] public float confidence;

        public ScanV2Observation(Vector3 position, Vector3 normal, float confidence = 1f)
        {
    ...
    [Serializable]
    public struct ScanV2WallCandidate
    {
    ...
    public sealed class SparseSurfelVolume
    {
        ...
        public void Integrate(IReadOnlyList<ScanV2Observation> observations)
        {
        ...
        public List<ScanV2Surfel> Extract(int minObservations)
        {
            var result = new List<ScanV2Surfel>(_cells.Count);
    ...
    public sealed class ScanV2StructuralResult
    {
        public bool hasFloor;
        public float floorY;
        public readonly List<ScanV2WallCandidate> walls = new();
    }

    public static class ScanV2Geometry
    {
        private sealed class WallCluster
        {
            ...
            public float weight;
            public int count;
            public readonly List<ScanV2Surfel> points = new();
        }

        public static ScanV2StructuralResult ExtractStructure(
            IReadOnlyList<ScanV2Surfel> surfels,
        ...
        {
            var result = new ScanV2StructuralResult();
                                           ...
                                           ScanV2StructuralResult result)
        {
            ...
            a.y = b.y = baseY;
            result.walls.Add(new ScanV2WallCandidate
            {
                aLocal = a,
                bLocal = b,
        ...
        public static void CloseNearbyCorners(List<ScanV2WallCandidate> walls,
        ...
        private static int NearestEndpoint(ScanV2WallCandidate wall, Vector3 point,
                                           out float distance)
        {
        ...
        public static bool IsDuplicate(WallObject wall, ScanV2WallCandidate candidate,
        ...
        private static void FindFloor(IReadOnlyList<ScanV2Surfel> surfels, int minimum,
                                      float minimumArea, ScanV2StructuralResult result)
        {
