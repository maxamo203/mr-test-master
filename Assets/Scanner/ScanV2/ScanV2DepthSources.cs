...
{
    public interface IScanV2DepthSource
    {
        string Name { get; }
        bool TryCapture(Camera camera, List<ScanV2Observation> output);
    }
    ...
    public sealed class NativeEnvironmentDepthSource : IScanV2DepthSource
    {
        ...
        public bool TryCapture(Camera camera, List<ScanV2Observation> output)
        {
            ...
            try
            {
                ...
                for (int column = 0; column < columns - 1; column++)
                {
                    ...
                    output.Add(new ScanV2Observation(
    ...
    public sealed class ARRaycastDepthSource : IScanV2DepthSource
    {
